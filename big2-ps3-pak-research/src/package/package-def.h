...
struct ResPage //0x10
{
	...
	uint32_t m_pageSize;							//0x4 size maybe from the start of PakPageHeader
	uint32_t m_unk2;								//0x8 always 0 ?
	uint32_t m_numPageHeaderEntries;				//0xC number of pointers in the table
};
