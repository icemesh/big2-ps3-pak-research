...
{
	{SID("standard"), 1},				//0x13A1C349
	{SID("bg"), 3},						//0x73F552F7
	{SID("fg"), 4},						//0x36D1735E
	{SID("lodhigh"), 5},				//0x4FB9A76C
	{SID("lodfadeouthigh"), 6},			//0x9620A15F
	{SID("lodfadeouthighe"), 6},		//0xA45A84D0
	{SID("loddlightshigh"), 7},			//0xFB87606F
	{SID("loddlightsfadeouthigh"), 8},	//0x61436C8C
	{SID("lodhighlm"), 9},				//0xF7BB54C0
	{SID("lodfadeouthighlm"), 0xA},		//0x7D963218
	{SID("lodfadeouthighelm"), 6},		//0x0727CA13
	{SID("loddlightshighlm"), 0xB}, //0x2F5ECD5E
	{SID("loddlightsfadeouthighlm"), 0xC},	//0xD554B5CD
	{SID("shadows"), 0xD},					//0xEC715CFF
	{SID("techniquedebug"), 0xE},			//0x9EEAE8DD
	{SID("localshadows"), 0xF},				//0xA4B72862
	{SID("depthonly"), 0x10},				//0x2D58544E
	{SID("depthonlyfadeout"), 0x11},		//0x8A29A4E6
	{SID("normaldepthonly"), 0x12},			//0xE2F6CA87
	{SID("surfacereflection"), 0x13},		//0x5B4F7F98
	{SID("motionblur"), 0x14},				//0x2A7F0331
	{SID("motionblurfadeout"), 0x15},		//0x1CABB1B7
	{SID("decalraycast"), 0x16},			//0xBD484A02
	{SID("hairpass1"), 0x17},				//0xDD620175
	{SID("hairpass2"), 0x18},				//0xD02127AC
	{SID("waterfall"), 0x19},				//0xFCD2EFB6
	{SID("waterriver"), 0x1B},				//0x950E94A9
	{SID("waterocean"), 0x1A},				//0x58E6953A
	{SID("debugvertexnormals"), 0x26},		//0x2FE39D50
	{SID("debugvertextangents"), 0x27},		//0x2CC3824F
	{SID("debugvertexbinormals"), 0x28},	//0x1DF2D505
	{SID("debugwireframe"), 0x29},			//0xCB45FDA0
	{SID("2d"), 0x1C},						//0x2FA18371
	{SID("3d"), 0x1D},						//0xFDB842AD
	{SID("4d"), 0x1E},						//0xCA773CD7
	{SID("text"), 0x1F},					//0xF3D3F1A9
	{SID("gametext"), 0x20},				//0xFD454010
	{0xC2262D4, 0x21},
	{0x677ACA45, 0x22},
	{0x3987299E, 0x23},
	{0x124AD18D, 0x24},
